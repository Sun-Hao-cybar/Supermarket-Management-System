...
const knowledgeBase = [
  ...
  },
  {
    ...
    answer: '喵~ 点击左侧"员工管理"菜单，页面会显示所有员工的列表。在顶部搜索框中输入姓名、员工编号或电话，即可快速筛选定位到目标员工~'
  },
  {
  ...
  },
  {
    ...
    question: '如何查找某个会员？',
    answer: '喵~ 点击左侧"会员管理"，在页面顶部搜索框中输入会员姓名、电话或会员编号，即可快速筛选找到目标会员~'
  },
  {
    keywords: ['导出', '会员', 'excel', '下载'],
    question: '如何导出会员数据？',
    answer: '喵~ 在"会员管理"页面，点击"导出Excel"按钮，系统会自动下载所有会员数据的 Excel 文件~'
  },
  ...
  {
    keywords: ['导入', '商品', '批量', 'excel'],
    question: '如何导入商品数据？',
    answer: '喵~ 在"商品管理"页面，点击"导入Excel"按钮，下载模板填写商品信息后上传即可~'
  },
  {
    keywords: ['导出', '商品', 'excel', '下载'],
    question: '如何导出商品数据？',
    answer: '喵~ 在"商品管理"页面，点击"导出Excel"按钮，系统会自动下载所有商品数据的 Excel 文件~'
  },
  {
    keywords: ['查看', '查询', '查找', '浏览', '搜索', '商品', '信息', '列表', '在哪里看'],
    question: '如何查看商品信息？',
    answer: '喵~ 点击左侧"商品管理"菜单，页面会显示所有商品的列表，包括编码、名称、单价、供应商、库存等信息。在顶部搜索框中输入商品名称或编码可以快速找到特定商品~'
  },
  {
  ...
  {
    keywords: ['分类', '商品分类', '筛选', '过滤'],
    question: '如何筛选查找商品？',
    answer: '喵~ 在"商品管理"页面顶部的搜索框中输入商品名称或编码，系统会自动筛选匹配的商品。你也可以点击列名排序来整理列表~'
  },
  {
    keywords: ['供应商', '商品', '关联'],
    question: '商品如何关联供应商？',
  ...
  // ==================== 采购管理 ====================
  {
    keywords: ['添加', '采购单', '创建', '新建'],
    question: '如何创建采购单？',
    answer: '喵~ 点击左侧"采购管理"（或"采购信息"），在页面顶部点击"添加采购单"按钮。先填写采购主单信息（供应商、日期等），然后添加采购明细（选择商品、填写数量和单价），保存后采购单就创建好啦~'
  },
  {
    keywords: ['编辑', '修改', '采购单', '还能', '已经', '审批通过', '审批过', '过了', '能否', '不能', '数量', '还能改', '能不能'],
    question: '如何修改采购单？审批后能否修改？',
  ...
  {
    keywords: ['审批', '采购审批', '状态', '通过', '审核', '采购单'],
    question: '采购单有哪些状态？如何审批？',
    answer: '喵~ 采购单一般有"待审批"、"已通过"、"已拒绝"等状态。一号和三号管理员可以审批采购单，在采购单详情中点击"通过"或"拒绝"按钮即可~'
  },
  {
    keywords: ['重新提交', '被拒', '拒绝', '审批被拒', '驳回', '修改', '采购单', '没通过', '审批没', '怎么重新', '如何重新'],
    question: '采购单审批被拒后如何重新提交？',
    answer: '喵~ 采购单被拒后，点击左侧"采购管理"→在列表中找到被拒的采购单→点击"编辑"按钮→根据拒绝原因修改采购单信息→保存后采购单状态会重置为"待审批"，重新提交审批即可。注意：只有未审批通过的采购单才能编辑哦~'
  },
  {
  ...
  {
    keywords: ['导入', '供应商', '批量', 'excel'],
    question: '如何导入供应商数据？',
    answer: '喵~ 在"供应商管理"页面，点击"导入Excel"按钮，下载模板填写供应商信息后上传即可~'
  },
  {
    keywords: ['查看', '查询', '查找', '浏览', '搜索', '供应商', '列表', '在哪里看'],
    question: '如何查看/查找供应商信息？',
    answer: '喵~ 点击左侧"供应商管理"菜单，页面会显示所有供应商的列表。在顶部搜索框中输入供应商名称、编码或联系人，即可快速找到目标供应商~'
  },
  {
    keywords: ['编辑', '修改', '供应商'],
    question: '如何编辑供应商信息？',
  ...
  {
    keywords: ['导出', '供应商', 'excel', '下载'],
    question: '如何导出供应商数据？',
    answer: '喵~ 在"供应商管理"页面，点击"导出Excel"按钮，系统会自动下载所有供应商数据的 Excel 文件~'
  },
  {
